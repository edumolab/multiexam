...
function step0() {
	...
	que.innerHTML="Do you think it is important to keep the city clean?";
	que_id.innerHTML=1
	audio1.play();
...
function step1(){
	que.innerHTML="Do you recycle things like paper and plastic?";
	que_id.innerHTML=2
	audio2.play();
...
function step2(){
	que.innerHTML="What do you do when you see rubbish on the street?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="Can you suggest why some people throw their litter on the ground?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="Do you think plastic bags are a serious environmental problem?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="Do you think it is important to protect the environment?";
	que_id.innerHTML=6
	audio6.play();
...
function step6(){
	que.innerHTML=`<p><b>Describe a time you visited a place with your friends.</b></p><p>You should say:</p><ul><li>Where you went</li><li>What you did there</li><li>whom you were with</li><li>and explain why it was a memorable experience.</li></ul><br><textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Izoh yozish uchun"></textarea>`;
	que_id.innerHTML=7
	audio8.play();
...
function step7(){
	que.innerHTML="Do you think childhood friendship can last for long?";
	que_id.innerHTML=8
	audio10.play();
...
function step8(){
	que.innerHTML="Is it important that people should have good friendship while at work?";
	que_id.innerHTML=9
	audio11.play();
...
function step9(){
	que.innerHTML="Do you remember the friends you had made in your childhood?";
	que_id.innerHTML=10
	audio12.play();
...
function step10(){
	que.innerHTML="Is it easy to make friends now as compared to the past?";
	que_id.innerHTML=11
	audio13.play();
