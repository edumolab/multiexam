...
function step0() {
	...
	que.innerHTML="Do you like math?";
	que_id.innerHTML=1
	audio1.play();
...
//Step1 fun
function step1(){
	que.innerHTML="Do you think females are good at maths?";
	que_id.innerHTML=2
	audio2.play();
...
function step2(){
	que.innerHTML="When did you start learning Math?";
	que_id.innerHTML=3
	audio3.play();
...
function step3(){
	que.innerHTML="Do you think maths is important?";
	que_id.innerHTML=4
	audio4.play();
...
function step4(){
	que.innerHTML="Who taught you maths?";
	que_id.innerHTML=5
	audio5.play();
...
function step5(){
	que.innerHTML="Is maths difficult for you to learn?";
	que_id.innerHTML=6
	audio6.play();
...
function step6(){
	que.innerHTML=`<p><b>Describe a singer that you like.</b></p><p>You should say:</p><ul><li>Who the person is</li><li>How you know the person</li><li>what you liked about your friend</li><li>And explain why you like the person</li></ul><br><textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Izoh yozish uchun"></textarea>`;
	que_id.innerHTML=7
	audio8.play();
...
function step7(){
	que.innerHTML="What kinds of music are popular in your country?";
	que_id.innerHTML=8
	audio10.play();
...
function step8(){
	que.innerHTML="Do singers make lots of money?";
	que_id.innerHTML=9
	audio11.play();
...
function step9(){
	que.innerHTML="Do you play any musical instruments?";
	que_id.innerHTML=10
	audio12.play();
...
function step10(){
	que.innerHTML="What do old people like to listen to?";
	que_id.innerHTML=11
	audio13.play();
...
function step11(){
	que.innerHTML="How do you think music affects on person's mood?";
	que_id.innerHTML=12
	audio14.play();
