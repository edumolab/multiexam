...
var savol=[
   ...
   '<p><b>Describe a positive change in your life</b></p><p>You should say:</p><ul><li>what the change was about</li><li>when it happened</li><li>describe details of the change happened</li></ul><br><textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Izoh yozish uchun"></textarea>',
   'Do you think changes are always good?',
   'Do you believe with age, we become more positive about life and tend to change with our surroundings?',
   ...
   'How have young people\'s expectations from their lives changed over the decade?Is this more positive or negative?'
	]
