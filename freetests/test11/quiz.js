...
var savol=[
   ...
   '<p><b>Describe a city you have visited that you like very much. </b></p><p>You should say:</p><ul><li>What its name is and where it is</li><li>when you visited it</li><li>why you liked it</li><li>And the major attractions in this city are</li></ul><br><textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Izoh yozish uchun"></textarea>',
